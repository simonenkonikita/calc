...
import { OffersEmptyState } from "./components/OffersEmptyState/OffersEmptyState";
...
export const OffersSection: React.FC = () => {
  ...
  // 🔥 Формируем вкладки для банков
  const bankTabs = banks.map((bank) => {
  ...
  return (
    <div className="offers-section">
      <AdminLayout title="📄 Офферы (предложения банков)">
        ...
        {/* 🔥 Используем универсальный Tabs вместо BankTabs */}
        <Tabs
          tabs={bankTabs}
          selectedId={selectedBankId}
          onSelect={setSelectedBankId}
          emptyMessage="😕 Нет активных банков"
          emptyHint="Активируйте банк в разделе 'Банки-партнеры'"
        />
