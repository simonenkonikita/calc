...
import { ApartmentTypesSection } from "../ApartmentTypesSection/ApartmentTypesSection";
        ...
        <div className="admin-table-wrapper">
          <table className="admin-table">
            ...
            <tbody>
              ...
              {filteredComplexes.length === 0 && !isCreating && (
                <tr>
                  <td
                    colSpan={6}
                    style={{
                  ...
                  >
                    Нет ЖК в этой компании. Нажмите "Добавить ЖК" чтобы создать
                    первый.
                  </td>
                </tr>
              )}
