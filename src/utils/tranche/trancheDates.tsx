 ...
 * @param complexName - название ЖК
 * @returns true - доступна, false - недоступна
 */
 ...
 * @param complexName - название ЖК
 * @returns дата в формате "YYYY-MM-DD" или null, если недоступно
 */
 ...
 * @param complexName - название ЖК
 * @returns количество месяцев или null, если недоступно
 */
 ...
 * @param date1 - начальная дата (YYYY-MM-DD)
 * @param date2 - конечная дата (YYYY-MM-DD)
 * @returns количество месяцев
 */
...
/**
 * Получение списка всех ЖК без траншевой ипотеки
 * @returns массив названий ЖК
 */
 ...
 * @param complexName - название ЖК
 * @returns объект с датой и статусом
 */
